      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <nav className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <div>
              <span className="absolute top-0  bg-yellow-400 h-5 w-5 text-center rounded-full text-black font-bold sm:top-2">
                {products.length}
              </span>
              <ShoppingCartIcon onClick={openCheckout} className="h-10" />
            </div>
